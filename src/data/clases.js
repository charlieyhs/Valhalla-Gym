export const CLASES = [
  {
    ...
    intensidad: 9,
    calorias: 450,
    imagen: '/src/assets/clases/crossfit.webp',
    instructor: 'Carlos Mendez',
    instructorImagen: '/src/assets/coaches/entrenador1.webp',
    capacidad: 15,
    inscritos: 12,
    rating: 4.8,
    reviews: 89,
  ...
  },
  {
    ...
    intensidad: 3,
    calorias: 180,
    imagen: '/src/assets/clases/yoga.webp',
    instructor: 'María González',
    instructorImagen: '/src/assets/coaches/entrenador3.webp',
    capacidad: 20,
    inscritos: 16,
    rating: 4.9,
    reviews: 124,
  ...
  },
  {
    ...
    intensidad: 8,
    calorias: 400,
    imagen: '/src/assets/clases/spinning.webp',
    instructor: 'Ana Rodriguez',
    instructorImagen: '/src/assets/coaches/entrenador4.webp',
    capacidad: 25,
    inscritos: 22,
    rating: 4.7,
    reviews: 156,
  ...
  },
  {
    ...
    intensidad: 8,
    calorias: 500,
    imagen: '/src/assets/clases/boxeo.webp',
    instructor: 'Roberto Silva',
    instructorImagen: '/src/assets/coaches/entrenador2.webp',
    capacidad: 12,
    inscritos: 9,
    rating: 4.6,
    reviews: 78,
  ...
  },
  {
    ...
    intensidad: 4,
    calorias: 250,
    imagen: '/src/assets/clases/pilates.webp',
